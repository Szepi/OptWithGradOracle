...
= \int f(x-y)\mu'(dy) \,,
\end{align*}
where the second equality results from the definition $\mu'_{x}(A)=\mu'(x-A)$. Since $\mu':\cX\to \cX^*$ is a finite measure, we can define \todoc{We should be using the total variation measure.}
\begin{align*}
