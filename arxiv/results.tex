...
\[
\Delta_n^{*}(\F_{L,0}, c_1,c_2) \le K_1\left(\dfrac{D \sqrt{C_1^{\frac{q}{p}} C_2}}{\sqrt n}\right)^{\frac{p}{p+\frac{q}{2}}},
\]
...
\[
\Delta_n^{*}(\F_{L,0}, c_1,c_2) \le K_2\left(\dfrac{\sqrt{C_1^{\frac{q}{p}} C_2}}{\sqrt n}\right)^{\frac{2p}{p+q}},
\]
...
% Consider the class $\F_{L,0}$ of functions with domain $\cK$. \todoc{Probably the notation should be $\F_{L,0}(\cK)$?} 
\[
\Delta_n^{*}(\F_{L,0}, c_1,c_2) \ge K_3 \left(\dfrac{d^{\frac{q}{4p}} C_2 C_1^{\frac{q}{2p}}}{\sqrt n}\right)^{\frac{p}{p+\frac{q}{2}}},
\]
...
\[
\Delta_n^{*}(\F, c_1,c_2) \ge K_4  \left(\dfrac{C_2 C_1^{\frac{q}{2p}}}{\sqrt {d n}}\right)^{\frac{2p}{p+\frac{q}{2}}}, 
\]
...
\end{enumerate}
 where $K_5 = \frac{p}{C_2(p+\tfrac{q}{2})} \left(\frac{q}{2C_1(p+\tfrac{q}{2})}\right)^{\frac{q}{2p}}$.
\begin{proof}
