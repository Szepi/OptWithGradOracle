...
Another possibility is to use the so-called smoothing technique to obtain type-II oracles \citep{PoTsy90,flaxman2005online,AbHaRa08,Ne11:TR,HaLe14:SOC}\todoa{ Cs: Is this correct?} 
While the one-point estimators are intriguing, as discussed beforehand, 
in the optimization setting one can also always group two consecutive observations and obtain similar smoothing-type estimates \citep{katkul,kushcla,spall1992multivariate,spall1997one,bhatnagar-book,duchi2015optimal}
