...
Another possibility is to use the so-called smoothing technique \todoc{Add citations, including Flaxman, Nesterov, Polyak Tsybakov, Hazan and Levy} to obtain type-II oracles. \todoc{Actually, smoothing: This could be done with one or two observations. Again, differences may happen.}
