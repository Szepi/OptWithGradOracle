...
There are several examples of oracles satisfying these definitions and a non-exhaustive list is as follows:
\citep[pp.~58--60]{kushcla}, \cite{katkul}, \cite{spall1992multivariate}, \cite{flaxman2005online}, \cite{Ne11:TR}, \cite{PoTsy90}.
