...
\[
 \Delta_{\F_{L,0},n}^{*}(c_1,c_2) \ge K_3\sqrt{d} \, C_1^{\frac{q}{2p+q}} C_2^{\frac{p}{2p+q}} n^{-\frac{p}{2p+q}}, % \left(\dfrac{C_1^{\frac{q}{p}}C_2}{n}\right)^{\frac{p}{2p+q}},
\]
...
\[
\Delta_{\F_{L,1}, n}^{*}(c_1,c_2) \ge K_4 \,  C_1^{\frac{2q}{2p+q}} C_2^{\frac{2p}{2p+q}} n^{-\frac{2p}{2p+q}}\,. % \left(\dfrac{C_1^{\frac{q}{p}} C_2}{n} \right)^{\frac{p}{p+q/2}}\,.
\]
\end{itemize}
Above,
