...
% \begin{align*}
 ...
 \frac{R_{\F_{L,0},n}^*(c_1,c_2)}{n}\!=\! O\!\!\left(\!\!\left(\dfrac{DC_1^{\frac{q}{p}}C_2}{\sqrt{n}}\right)^{\!\!\frac{p}{p+\frac{q}{2}}}\!\right)\,,
\vspace{-0.3cm}
 \]
 %\end{align*}
...
& \le  \frac{R_{\F_{L,\mu,\cR},n}^*(c_1,c_2)}{n} =  O\!\left( \!\left(\dfrac{C_1^{\frac{q}{p}} C_2}{\sqrt{n}} \right)^{\!\!\frac{2p}{p+q}} \right).
\vspace{-0.5cm}
\end{align*}
\end{theorem}
...
$\cK\subset \R^d$ convetypeed, with  $[+1,-1]^d\subset \cK$.
