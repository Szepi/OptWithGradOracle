...
The proof of this theorem follows the steps of the standard analysis of the mirror descent algorithm
 ...
 and because it is somewhat cumbersome to extract from the existing results what properties of the oracles they use.\todoa{Comment on the relation of $R$ and $D$ for type-I oracles to show that the regret bound is essentially the same as the optimization bound.}
