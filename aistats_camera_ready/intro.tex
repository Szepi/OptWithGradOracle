...
of online bandit convex optimization cannot be achieved by the current analysis techniques of the currently used gradient estimation procedures, and our lower bounds even invalidate the claimed weaker upper bound of \cite{DeElKo15}.
