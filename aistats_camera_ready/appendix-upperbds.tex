...
$\EE{\tf_t(Y_t)-\tf_t(X_t)} \le c_3(\delta) = N \delta^2$. This holds for the smooth case when $\EE{Y_t|\cF_t}=X_t$, since then
$\EE{\tf_t(Y_t)-\tf_t(X_t)|\cF_t} \le \EE{\ip{\nabla \tf_t(X_t),Y_t-X_t}+\tfrac{L}{2}\|X_t-Y_t\|^2|\cF_t} \le L\delta^2/2$, where we used that $\EE{Y_t-X_t|\cF_t}=0$.
