...
Let $\cS_t$ denote the $\sigma$-algebra of all random events up until and including the selection of $X_t$. Since the oracle has unbiased evaluation, that is,  $\EE{Y_t|\cS_t}=X_t$, we have
\begin{equation}
