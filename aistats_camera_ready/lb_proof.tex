...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
\subsubsection{Proof of Theorem \ref{thm:lb-convex} for convex + smooth function class $\F_{L,0}(\K)$}
...
Prashanth: I have incorporated this constraint in lb bounds - pl. see condition after Theorem 3.}
\todoa[inline]{Where is the condition on $\delta<1$ used? I actually added the large enough $n$ condition and removed $q\ge 2$.}
as long as $\epsilon<\frac{2z+1}{C_1^{2z-1}(z+1)^z}$ (note that $\epsilon/C_1 \ge {\delta^*}^p$),
and for any choice of $\delta$, the following lower bound for the minimax error:
\[
\Delta_n^{*} \ge \dfrac{\epsilon}{2} \left(1 - \sqrt{n}  K_5 \epsilon^{\frac{p+\tfrac{q}{2}}{p}}\right), \text{ where } K_5 = \dfrac{p}{C_2(p+\tfrac{q}{2})} \left(\dfrac{q}{2C_1(p+\tfrac{q}{2})}\right)^{\frac{q}{2p}}.
\]
 
Plugging in $\epsilon = \left(\dfrac{1}{2\sqrt{n} K_5} \right)^{\frac{p}{p+\frac{q}{2}}}$ we see that the conditions on $\epsilon$ are satisfied for large enough $n$, and for such $n$ we obtain
\begin{align}
\Delta_n^{*} \ge \dfrac{1}{4}\left(\dfrac{1}{2 K_5 \sqrt n}\right)^{\frac{p}{p+\frac{q}{2}}}.
\label{eq:lb-pq}
\end{align}

Now, when $q=2$ and $p=1$, this simplifies to
\[
\Delta_n^{*} \ge \dfrac{\sqrt{C_1 C_2}}{2\sqrt{2}} n^{-1/4}, \text{ for } \epsilon=\sqrt{2C_1C_2} n^{-1/4}.
\]
On the other hand, for $p=q=2$, we get
\[
\Delta_n^{*} \ge  \frac{3}{8}\left(\frac{C_1 C_2^2}{16}\right)^{1/3} n^{-1/3} \text{ for } \epsilon=\frac{3}{2}\left(\frac{C_1 C_2^2}{16}\right)^{1/3}n^{-1/3}.
\]
...
General $p, q >0$:
\begin{align}
\Delta_n^{(d)*} \ge \dfrac{1}{4} d^{\frac{q}{(4p+2q)}} \left(\dfrac{1}{2 K_5 \sqrt n}\right)^{\frac{p}{p+\frac{q}{2}}} \text{ for } 
\epsilon = d^{\frac{-(4p+q)}{(4p+2q)}}\left(\dfrac{1}{2\sqrt{n} K_5} \right)^{\frac{p}{p+\frac{q}{2}}}.
\label{eq:lb-pq-d}
\end{align}
...
\subsubsection{Proof of Theorem \ref{thm:lb-convex} for strongly convex + smooth function class $\F_{L,1}(\K)$}
...
\paragraph{Derivation of the rates uniformly for all $\delta$:}
Replacing the positive part function in \eqref{eq:final-lower-bd-sc} and optimizing $\delta$, we obtain the following:
\[
\delta^*=\left(\frac{\nu q}{2C_1(p+q/2)}\right)^{1/p}
\]
as long as $\nu<\frac{2z+1}{C_1^{2z-1}(z+1)^z}$, with $z=p/q$ (note that $\epsilon/C_1 \ge {\delta^*}^p$),
and for any choice of $\delta$, the following lower bound for the minimax error:
% and for any choice of $\delta$, the minimax error $\Delta_n^{*}$ satisfies
\[
\Delta_n^{*} \ge \dfrac{\nu^2}{2} \left(1 - \sqrt{n}  K_5 \nu^{\frac{p+\tfrac{q}{2}}{p}}\right), \text{ where } K_5 = \dfrac{p}{C_2(p+\tfrac{q}{2})} \left(\dfrac{q}{2C_1(p+\tfrac{q}{2})}\right)^{\frac{q}{2p}}.
\]

Plugging in $\nu = \left(\dfrac{1}{2\sqrt{n} K_5} \right)^{\frac{p}{p+\frac{q}{2}}}$, we obtain
\begin{align}
\Delta_n^{*} \ge \dfrac{1}{4}\left(\dfrac{1}{2 K_5 \sqrt n}\right)^{\frac{2p}{p+\frac{q}{2}}}.
\label{eq:lb-pq}
\end{align}

Now, when $q=2$ and $p=1$, this simplifies to
\[
\Delta_n^{*} \ge \dfrac{C_1 C_2}{2} n^{-1/2}, \text{ for } \nu = 2C_1C_2 n^{-1/2}.
\]
On the other hand, for $p=q=2$, we get
\[
\Delta_n^{*} \ge  \frac{9}{4}\left(\frac{C_1 C_2^2}{16}\right)^{1/3} n^{-2/3} \text{ for } \nu=\frac{9}{2}\left(\frac{C_1 C_2^2}{16}\right)^{1/3}n^{-2/3}.
\]
...
General $p, q >0$:
\begin{align}
\Delta_n^{(d)*} \ge \dfrac{1}{4} d^{\frac{-2p}{(2p+q)}} \left(\dfrac{1}{2 K_5 \sqrt n}\right)^{\frac{2p}{p+\frac{q}{2}}} \text{ for } 
\nu = d^{\frac{-(4p+q)}{(2p+q)}}\left(\dfrac{1}{2\sqrt{n} K_5} \right)^{\frac{p}{p+\frac{q}{2}}}.
\label{eq:lb-pq-d}
\end{align}
