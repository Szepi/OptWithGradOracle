...
\label{eq:lb-pq}
\end{align}
The conditions on $n$ given in the theorem statement can be inferred from (i) the requirement that $\epsilon<\frac{2z+1}{C_1^{2z-1}(z+1)^z}$ (ii) $\delta \le 1$ in the oracle definition and (iii) the optimal choice of $\epsilon$ above.
