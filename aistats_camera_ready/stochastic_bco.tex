...
\todoc[inline]{We had: ``under slightly stronger assumptions.'' Stronger than what? Add back if we add this info.}
...
\todoc{I replaced $\sup_V$ with $\esssup$ which is what we need. I assume the appendix will need to be updated.}
\todoc{It is not very clear which entries this proposition gives.}
...
\todoc{I fixed this last sentence. Now I think it makes sense.}
\begin{proposition}
