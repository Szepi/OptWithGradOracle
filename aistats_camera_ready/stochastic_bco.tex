...
$C_2=4 \EE{\norm{V}_*^2}\left( \sup_V \E[\xi^2|V]+\sup_{x\in\D} f^2(x)\right)$, and $C_1 =
...
Note that this is larger than the error achieved by the algorithms of \citet{liang2014zeroth,BubeckDKP15,BuEl15}, but the apparent contradiction is easily resolved by noticing the difference in their error measure: distance to the optimum vs. distance n the function value.
