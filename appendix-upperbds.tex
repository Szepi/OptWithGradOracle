...
To simplify notation, here we call the loss function $f$, not $\tilde{f}$ as stated in \cref{lem:ub}. Before the proof, we introduce a well known bound on the instantaneous linearized regret of Mirror Descent. 
\begin{lemma}
