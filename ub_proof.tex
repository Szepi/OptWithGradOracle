...
\todox[inline]{Considering that we want to prove upper bound for type-II oracle, the loss function in the lemma is actually $\tilde{f}$...It must confuse most readers...}
\begin{lemma}
\label{lem:ub}
