...
\headerbox{Convex Optimization}{name=problems,column=0,row=0}{
...
\\
Bandit feedback $\equiv$ zeroth-order information
\\
...
\headerbox{State of the Art}{name=stateoftheart,column=0,below=problems}{

Ellipsoid method and relatives:

\begin{itemize}\compresslist
\item  Agarwal et al. (2013) --  $\sqrt{d^{33}/n}$.
\item Liang et al. (2014) -- $\sqrt{d^{14}/n}$.
\end{itemize}
